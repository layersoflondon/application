...
@observer export default class MapView extends Component {
  ...
  render() {
    ...
    const layers = <span className="tile-layers">
      <TileLayer url="https://api.maptiler.com/maps/basic/256/{z}/{x}/{y}.png?key=qyf8wWyodKCn5d8UagsY" attribution="&copy; Maptiler and <a href=&quot;http://osm.org/copyright&quot;>OpenStreetMap</a> contributors" maxZoom={this.props.mapViewStore.MAX_ZOOM} />
