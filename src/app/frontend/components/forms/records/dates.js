          ...
          <div className="end-date">
            ...
            <div>
              <input placeholder="Day"
                     ...
                     defaultValue={(this.props.recordFormStore.record.autogenerated_date_to_parts.date ? "" : this.props.recordFormStore.record.date_to_object.date)}
                    //  onChange={this.handleOnDateChange.bind(this)} 
                     onBlur={this.handleOnBlur}
              />
              <input placeholder="Month"
                     ...
                     data-date-attribute-name="month"
                     data-date-group="date_to"
                     defaultValue={(this.props.recordFormStore.record.autogenerated_date_to_parts.month ? "" : this.props.recordFormStore.record.date_to_object.month)}
                    //  onChange={this.handleOnDateChange.bind(this)}
                     onBlur={this.handleOnBlur}
              />
              <input placeholder="Year"
                     ...
                     data-date-attribute-name="year"
                     data-date-group="date_to"
                     defaultValue={(this.props.recordFormStore.record.autogenerated_date_to_parts.year ? "" : this.props.recordFormStore.record.date_to_object.year)}
                    //  onChange={this.handleOnDateChange.bind(this)}
                     onBlur={this.handleOnBlur}
              />
            </div>
